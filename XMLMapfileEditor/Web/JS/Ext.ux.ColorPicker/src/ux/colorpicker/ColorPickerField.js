...
Ext.define('Ext.ux.colorpicker.ColorPickerField', {
    ...
    onChange: function (picker, newValue, oldValue, opts) {
        this.setFieldStyle('background-color: ' + picker + '; background-image: none;');
    },
    getJsonValue: function () {
        var json = {};
        //color
        var color = new Ext.draw.Color.fromString(this.getValue());
